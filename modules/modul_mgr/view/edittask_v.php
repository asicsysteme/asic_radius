...
$id_modul   = $info_task->g('modul');
?>
<div class="pull-right tableTools-container">
	<div class="btn-group btn-overlap">
					
		<?php 
		TableTools::btn_add('task', 'Liste Application Modul ('.$info_task->g('description').') ', MInit::crypt_tp('id', $id_modul), $exec = NULL, 'reply'); 
...
$form = new Mform('edittask', 'edittask', '', 'task&'.MInit::crypt_tp('id', $id_modul),'');

$form->input_hidden('id_modul', $info_task->id_modul);
$form->input_hidden('id_checker_modul',  MInit::cryptage($info_task->id_modul, 1));
//Déscription application
$desc_array[]  = array('required', 'true', 'Insérer la Déscription' );
$form->input('Déscription', 'description', 'text' ,6 , $info_task->g('dscrip'), $desc_array);
//Nom Application
...
$form->input('Nom Application', 'app', 'text', 6, $info_task->g('app'), $app_array);
...
$form->select('Type d\'affichage', 'type_view', 5, $type_view, $indx = NULL , $info_task->g('type_view') );
//Service have rigths to run this app
$form->select_table('Services autorisés', 'services[]', 10, 'sys_services','id', 'service', 'service', $indx = NULL ,$selected = $info_task->g('services')  , 1, NULL, NULL);
//Show on action_list
...
$form->input('Icone', 'sbclass', 'text', 6 ,$info_task->g('sbclass') , $sbclass_array);
