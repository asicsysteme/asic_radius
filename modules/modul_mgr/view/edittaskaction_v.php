...
<div class="page-header">
	<h1>
		Editer  Task Action  : "<?php echo  $info_task_action->task_info['dscrip'] .' <i class="ace-icon fa fa-angle-double-right"></i> '.$info_task_action->task_action_info['descrip']. ' - '. $info_task_action->id_task_action. ' - ';?>"
		<small>
...
$form = new Mform('edittaskaction', 'edittaskaction', $info_task_action->task_action_info['id'], 'taskaction&'.MInit::crypt_tp('id', $info_task_action->id_task),'');


$form->input_hidden('id_task', $info_task_action->task_action_info['appid']);
$form->input_hidden('id_checker_task',  MInit::cryptage($info_task_action->task_action_info['appid'], 1));
$form->input_hidden('id', $info_task_action->task_action_info['id']);
